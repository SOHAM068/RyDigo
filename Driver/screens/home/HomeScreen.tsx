...
//   const ws = new WebSocket("ws://192.168.1.9:8080"); // Change the IP address to your WIFI IP address
...
//   useEffect(() => {
//     ws.onopen = () => {
//       // onopen means when the server opens the connection
//       console.log("Connected to WebScoket Server");
//       setWsConnected(true);
//     };

//     ws.onmessage = (e) => {
//       // onmessage means when the server sends a message to the client (driver)
...
//     ws.onclose = (e) => {
//       // onclose means when the server closes the connection
...
//         return; // Return if the location permission is not granted
//       }
...
//                         style={[
//                           styles.verticaldot,
//                           { borderLeftColor: "black" }, // Apply border color specifically to the left side
//                         ]}
//                       />
...
//                     }}
//                   >
//                     Distance: <Text style={{ fontWeight: "700" }}>25 km</Text>
//                   </Text>
//                   <Text
//                     style={{
...
//                     }}
//                   >
//                     Amount: <Text style={{ fontWeight: "700" }}>500 Rs</Text>
//                   </Text>
//                   <View
//                     style={{
//                       flexDirection: "row",
