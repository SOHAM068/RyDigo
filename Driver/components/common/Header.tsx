...
import { Notification } from "@/utils/IconsUtils";
...
export default function Header({ isOn, toggleSwitch }: HeaderProp) {
  return (
        ...
        >
          ...
          <View style={styles.switchBorder}>
            <SwitchToggle
              ...
              backgroundColorOff={color.primaryGray}
              backgroundColorOn={color.primaryGray}
