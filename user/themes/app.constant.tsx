...
export const IsIPAD = IsIOS && SCREEN_HEIGHT / SCREEN_WIDTH < 1.6; // 4:3 aspect ratio
export const ISAndroid = Platform.OS === "android";

export const IsHaveNotch = SCREEN_HEIGHT > 750; // iPhone X and above
...
export const windowHeight = (height: DimensionValue): number => {
  ...
  let tempHeight = SCREEN_HEIGHT * (parseFloat(height.toString()) / 667); // 667 is the standard height of iPhone 8
  return PixelRatio.roundToNearestPixel(tempHeight); // round it to the nearest pixel to avoid blurry text and images on Android devices
};
...
export const windowWidth = (width: DimensionValue): number => {
  ...
  let tempWidth = SCREEN_WIDTH * (parseFloat(width.toString()) / 480); // 480 is the standard width of iPhone 8
